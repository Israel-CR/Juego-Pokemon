...
// arreglos de imagenes y nombres  de los pokemones
let pokemonSearched = [];
let pokemonNames = [];
...
async function searchPokemonById(id) {
  ...
  pokemonSearched.forEach((pokemon) => {
    draggableElements.innerHTML += `
    <div class="pokemon">
        <img draggable="true" id="${pokemon.name}" class="image" src="${pokemon.sprites.other["official-artwork"].front_default}" alt="">
            </div>`;
  });

  //   insertando nombre de pokemones
